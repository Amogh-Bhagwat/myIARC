...
void callback(const sensor_msgs::PointCloud2ConstPtr& input, const std_msgs::Float64MultiArrayConstPtr& Coordinate)
{
...
int main (int argc, char** argv)
{
  	...
  	//Synchronizer<MySyncPolicy> sync(MySyncPolicy(10), depth_sub, point_sub);
  	//sync.registerCallback(boost::bind(&callback, _1, _2));
